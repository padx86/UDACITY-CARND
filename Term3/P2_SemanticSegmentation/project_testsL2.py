...
def test_layers(layers):
    ...
    layers_output, _ = layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes)
...
def test_optimize(optimize):
    ...
    l2losses = list()
    l2losses.append(layers_output)
    l2losses.append(layers_output)
    logits, train_op, cross_entropy_loss = optimize(layers_output, correct_label, learning_rate, num_classes, l2losses)
